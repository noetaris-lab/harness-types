 ...
 * `usage` is always present — all adapters must populate it.
 */
export interface LLMResponse {
  ...
  usage: {
    ...
    outputTokens: number
    /**
     * The model's total context window capacity in tokens.
     * Present only when the adapter can determine it.
     * Absent when the adapter cannot determine capacity.
     */
 ...
 * `contextWindowSize` mirrors `LLMResponse.usage.contextWindowSize` — present when the
 * adapter can determine it; absent otherwise.
 */
